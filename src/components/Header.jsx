...
export default function Header() {
  return (
    <>
    <nav className="flex justify-between items-center px-8 py-4 shadow-md bg-orange-100 w-[95vw] ml-5 mt-3 rounded-lg">
      {/* Left: Swiggy Logo SVG */}
      ...
      <ul className="flex items-center space-x-8 text-gray-700 font-medium">
        ...
        <li className="hover:text-orange-500 cursor-pointer"><Link to='/offers'>Offers 🏷️%</Link> </li>
        <li className="hover:text-orange-500 cursor-pointer"><Link to='/help'>Help 🤝</Link></li>
        <li className="hover:text-orange-500 cursor-pointer"><Link to='/signin'>Sign In 👤</Link></li>
